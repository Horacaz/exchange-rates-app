...
var CurrencyService = (function () {
    ...
    CurrencyService.prototype.getCurrenciesNames = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = mapCurrencies;
                        return [4, getCurrenciesNamesFromApi()];
                    case 1: return [2, _a.apply(void 0, [_b.sent()])];
                }
            });
        });
    };
    CurrencyService.prototype.getCurrencyRates = function (base) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = mapCurrency;
                        return [4, getCurrencyRatesFromApi(base)];
                    case 1: return [2, _a.apply(void 0, [_b.sent()])];
                }
            });
        });
